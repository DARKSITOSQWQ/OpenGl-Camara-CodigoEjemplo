...
void redimensionar(int w, int h){
	...
	glLoadIdentity();
	gluPerspective(80,16.0/9.0,1,485);
...
void limite(){
    ...
    ///////ELEVADOR//////
    ////PARED1
    g_camera.colision(152.51,171, 32.5, 37.8, 0, 45);
    ////PARED2
    g_camera.colision(165.2, 171.4, 32.5, 46.7, 0, 45);
    ////PARED3
    g_camera.colision(152.51, 171, 42.37, 47.6, 0, 45);
